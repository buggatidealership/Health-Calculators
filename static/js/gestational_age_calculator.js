  ...
  calculateBtn.addEventListener('click', function() {
    ...
    if (methodSelect.value === 'lmp') {
      ...
      if (usWeeks === 0 && usDays === 0) {
        alert('Please enter the gestational age from the ultrasound report.');
        return;
      }
    ...
    if (totalDays < 0) {
      alert('The date you entered is in the future. Please check your input.');
      return;
    }
    if (totalDays > 301) { // ~43 weeks
      alert('The calculated gestational age exceeds 43 weeks. Please check your date.');
      return;
    }
