...
@app.route('/reel-preview-4')
def reel_preview_4():
    return render_template('reel-preview-4.html')
...
#     )
#
# /breast-implant-calculator: migrated to config-driven (configs/cosmetic.py)
...
#     )
#
# /breast-implant-size-calculator: migrated to config-driven (configs/cosmetic.py)
...
#     )
#
# /breast-implant-cost-calculator: migrated to config-driven (configs/cosmetic.py)
...
#     )
#
# /glp1-comparison-calculator: migrated to config-driven (configs/medications.py)
...
# /female-fertility-calculator: migrated to config-driven (configs/fertility.py)
...
# /dog-pregnancy-due-date-calculator: migrated to config-driven (configs/fertility.py)
...
#     )
# 
# /chipotle-nutrition-calculator: migrated to config-driven (configs/nutrition.py)
...
#     )
#
# /army-body-fat-calculator: migrated to config-driven (configs/fitness.py)
...
@app.route('/mockup-brand-v24')
def mockup_brand_v24():
    return render_template('mockup-brand-v24.html', is_homepage=True, robots_meta='noindex, nofollow')

@app.route('/mockup-brand-v27')
def mockup_brand_v27():
    return render_template('mockup-brand-v27.html', is_homepage=True, robots_meta='noindex, nofollow')

@app.route('/mockup-brand-v25')
def mockup_brand_v25():
    return render_template('mockup-brand-v25.html', is_homepage=True, robots_meta='noindex, nofollow')

@app.route('/mockup-brand-v28')
def mockup_brand_v28():
    return render_template('mockup-brand-v28.html', is_homepage=True, robots_meta='noindex, nofollow')

@app.route('/mockup-brand-v26')
...
@app.route('/mockup-calc-harmony')
def mockup_calc_harmony():
    return render_template('mockup-calc-harmony.html')

@app.route('/mockup-product-v5')
def mockup_product_v5():
    return render_template('mockup-product-v5.html')

@app.route('/mockup-product-v6')
def mockup_product_v6():
    return render_template('mockup-product-v6.html')
...
@app.route('/mockup-landing-harmony')
...
# /breastfeeding-calorie-calculator: migrated to config-driven (configs/nutrition.py)
...
# /fiber-intake-calculator: migrated to config-driven (configs/nutrition.py)
...
@app.route('/mockup-product-v8')
def mockup_product_v8():
...
@app.route('/preview-reels-batch3')
def preview_reels_batch3():
    return render_template('preview-reels-batch3.html')


@app.route('/preview-reels-imagen4')
def preview_reels_imagen4():
...
@app.route('/mockup-abodient-product')
